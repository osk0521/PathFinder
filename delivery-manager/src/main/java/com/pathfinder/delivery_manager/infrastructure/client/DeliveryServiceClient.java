...
@FeignClient(
        name = "delivery-service",      // Eureka에 등록된 서비스 이름
        path = "/internal/deliverys",    // 기본 경로: Controller의 @RequestMapping과 일치
...
public interface DeliveryServiceClient {
    ...
    /**
     * 사용자 정보 조회
     * 실제 호출 URL: http://delivery-service/internal/delivery/{username}
     *
     * @param username 조회할 사용자명
     * @return 사용자 정보 DTO
     */
    @GetMapping("/{username}")
    DeliveryManagerResponseDto geDeliveryManagerInfo(@PathVariable("username") String username);
}